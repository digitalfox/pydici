...
billing_urls = [ re_path(r'^bill_review$', v.bill_review, name="bill_review"),
                 ...
                 re_path(r'^bill/file/(?P<nature>.+)/(?P<bill_id>\d+)$', v.bill_file, name="bill_file"),
                 re_path(r'^bill/client/pdf/(?P<bill_id>\d+)$', v.BillPdf.as_view(), name="bill_pdf"),
                 re_path(r'^bill/client/html/(?P<bill_id>\d+)$', v.Bill.as_view(), name="bill_html"),
                 ...
                 re_path(r'^bill/internal/pdf/(?P<bill_id>\d+)$', v.InternalBillPdf.as_view(), name="internal_bill_pdf"),
                 re_path(r'^bill/internal/html/(?P<bill_id>\d+)$', v.InternalBillView.as_view(), name="internal_bill_html"),
                 re_path(r'^bill/internal/add$', v.internal_bill, name='internal_bill'),
                 re_path(r'^bill/internal/(?P<bill_id>\d+)/edit$', v.internal_bill, name='internal_bill'),
                 re_path(r'^bill/internal/(?P<bill_id>\d+)/delete$', v.internalbill_delete, name='internalbill_delete'),
                 re_path(r'^bill/internal/(?P<bill_id>\d+)/detail$', v.internal_bill_detail, name='internal_bill_detail'),
                 re_path(r'^bill/internal/creation$', v.internal_bills_in_creation, name='internal_bills_in_creation'),
                 re_path(r'^bill/internal/archive$', v.internal_bills_archive, name='internal_bills_archive'),
                 re_path(r'^internal_pre_billing/$', v.internal_pre_billing, name="internal_pre_billing"),
                 re_path(r'^internal_pre_billing/(?P<start_date>\d{6})/(?P<end_date>\d{6})/?$', v.internal_pre_billing, name="internal_pre_billing"),
                 ...
                 re_path(r'lead_billing/(?P<lead_id>\d+)$', v.lead_billing, name="lead_billing"),
                 ...
                 re_path(r'^datatable/internal_bills_in_creation/data/$', t.InternalBillInCreationTableDT.as_view(), name='internal_bills_in_creation_DT'),
                 re_path(r'^datatable/internal_bills_archive/data/$', t.InternalBillArchiveTableDT.as_view(), name='internal_bills_archive_DT'),
