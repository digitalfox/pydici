    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_broker', models.ForeignKey(related_name='lead_broker', verbose_name='Business broker', blank=True, to='crm.BusinessBroker', null=True)),
                ('client', models.ForeignKey(verbose_name='Client', to='crm.Client')),
                ('paying_authority', models.ForeignKey(related_name='lead_paying', verbose_name='Paying authority', blank=True, to='crm.BusinessBroker', null=True)),
                ('responsible', models.ForeignKey(related_name='lead_responsible', verbose_name='Responsible', blank=True, to='people.Consultant', null=True)),
                ('salesman', models.ForeignKey(verbose_name='Salesman', blank=True, to='people.SalesMan', null=True)),
