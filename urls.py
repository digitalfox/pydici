...
urlpatterns = patterns('',
    ...
    (r'^leads/pdcreview/(?P<year>\d+)/(?P<month>\d+)/(?P<n_month>\d+)', 'pydici.leads.views.pdc_review'),
    ...
    (r'^leads/pdcreview/proj/(?P<year>\d+)/(?P<month>\d+)/(?P<n_month>\d+)', 'pydici.leads.views.pdc_review', { "projected" : True }),
