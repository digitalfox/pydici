...
staffing_urls = [url(r'^pdcreview/?$', v.pdc_review, name='pdcreview-index'),
                 ...
                 url(r'^forecast/mission/(?P<mission_id>\d+)/$', v.mission_staffing, name="mission_staffing"),
                 ...
                 url(r'^rate_objective_report/?$', v.rate_objective_report, name="rate_objective_report"),
                 url(r'^rates_report/?$', v.rates_report, name="rates_report"),
