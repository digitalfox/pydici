...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StateProba'
        db.create_table(u'leads_stateproba', (
        ...
        db.send_create_signal(u'leads', ['StateProba'])


    def backwards(self, orm):
        # Deleting model 'StateProba'
        db.delete_table(u'leads_stateproba')
    ...
    models = {
        ...
        u'leads.lead': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 8, 0, 0)'}),
