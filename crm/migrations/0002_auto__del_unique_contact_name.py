...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Contact', fields ['name']
        db.delete_unique(u'crm_contact', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Contact', fields ['name']
        db.create_unique(u'crm_contact', ['name'])
