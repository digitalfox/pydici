...
leads_urls = [ re_path(r'^review/?$', v.review, name="review"),
               ...
               re_path(r'^activities', v.activities, name="activities"),
               re_path(r'^activity$', v.activity, name="activity"),
               re_path(r'^activity/(?P<activity_id>\d+)/change$', v.activity, name="activity"),
               re_path(r'^activity/(?P<activity_id>\d+)/detail$', v.activity_detail, name="activity_detail"),
               re_path(r'^activity/(?P<activity_id>\d+)/comments/add$', v.activity_comment_create, name="activity_comment_create"),
               re_path(r'^activity/comments/(?P<comment_id>\d+)/delete$', v.activity_comment_delete, name="activity_comment_delete"),
               re_path(r'^activity/comments/(?P<comment_id>\d+)/edit$', v.activity_comment_edit, name="activity_comment_edit"),
               ...
               re_path(r'^graph/activities-activity$', v.graph_activities_activity, name="graph_activities_activity"),
               re_path(r'^pivotable/leads$', v.leads_pivotable, name="leads-pivotable"),
               re_path(r'^pivotable/leads/(?P<start_date>\d{6})/(?P<end_date>\d{6})/$', v.leads_pivotable, name="leads-pivotable-date"),
               re_path(r'^pivotable/activities$', v.activities_pivotable, name="activities-pivotable"),
               re_path(r'^pivotable/activities/(?P<start_date>\d{6})/(?P<end_date>\d{6})/$', v.activities_pivotable, name="activities-pivotable-date"),
               ...
               re_path(r'^datatable/activities/company/(?P<company_id>\d+)/data/$', t.CompanyActivityTableDT.as_view(), name='company_activity_table_DT'),
               re_path(r'^datatable/activities/related/(?P<activity_id>\d+)/data/$', t.RelatedActivityTableDT.as_view(), name='related_activity_table_DT'),
              ]
