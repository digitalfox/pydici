...
people_urls = [
    ...
    re_path(r'^achievements/consultant/(?P<consultant_id>\d+)/$', v.consultant_achievements, name="consultant_achievements"),
    re_path(r'^profile/consultant/(?P<consultant_id>\d+)/$', v.consultant_profile, name="consultant_profile"),
