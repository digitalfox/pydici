...
staffing_urls = patterns('staffing.views',
                         ...
                         url(r'^holidays_report/(?P<year>\d+)$', 'holidays_report', name="holidays-pivotable-year"),
                         url(r'^holidays_report/?$', 'holidays_report', name="holidays-pivotable"),
                         url(r'^holidays_report/all$', 'holidays_report', {"year": "all"}, name="holidays-pivotable-all"),
