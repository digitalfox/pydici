...
pydici_patterns += patterns('leads.views',
    ...
    (r'^leads/lead$', 'lead'),
    (r'^leads/lead/(?P<lead_id>\d+)/change$', 'lead'),
...
pydici_patterns += patterns('staffing.views',
    ...
    (r'^staffing/pdc-detail/(?P<consultant_id>\d+)/(?P<staffing_date>\d+)/?$', 'pdc_detail'),
...
pydici_patterns += patterns('crm.views',
    (r'^crm/company/(?P<company_id>\d+)/detail$', 'company_detail'),
    (r'^crm/company/all?$', 'company_list'),
    (r'^crm/company$', 'company'),
    (r'^crm/company/(?P<company_id>\d+)/change$', 'company'),
    (r'^crm/client$', 'client'),
    (r'^crm/client/(?P<client_id>\d+)/change$', 'client'),
    (r'^crm/client-organisation$', 'clientOrganisation'),
    (r'^crm/client-organisation/(?P<client__organisation_id>\d+)/change$', 'clientOrganisation'),
...
pydici_patterns += patterns('billing.views',
    ...
    url(r'^billing/pre_billing$', 'pre_billing', {"mine": False, }),
