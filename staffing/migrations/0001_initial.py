    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nature', models.CharField(default=b'PROD', max_length=30, verbose_name='Type', choices=[(b'PROD', 'Productif'), (b'NONPROD', 'Non productif'), (b'HOLIDAYS', 'Cong\xe9s')])),
                ('billing_mode', models.CharField(max_length=30, null=True, verbose_name='Billing mode', choices=[(b'FIXED_PRICE', 'Forfait'), (b'TIME_SPENT', 'Temps pass\xe9')])),
