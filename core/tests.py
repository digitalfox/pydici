...
PYDICI_PAGES = ("/",
                ...
                "/staffing/holidays_pivot_report/2010",
                "/staffing/holidays_pivot_report/2009",
                "/staffing/holidays_pivot_report/all",
                "/staffing/holidays_pivot_report/",
                "/staffing/holidays_report/",
                "/staffing/holidays_report/2010/04",
                "/staffing/holidays_report/2015/04",
                ...
                "/leads/activities",
                "/leads/activity",
                "/leads/activity/1/detail",
                "/leads/pivotable/activities",
                "/billing/bill/client/1/edit",
                "/billing/bill/client/1/detail",
                "/billing/bill/client/creation",
                "/billing/bill/supplier/1",
                "/billing/bill/internal/add",
                "/billing/bill/internal/1/edit",
                "/billing/bill/internal/1/detail",
                "/billing/bill/internal/creation",
                "/billing/bill/internal/archive",
                "/billing/pre_billing/",
                ...
                "/crm/businessbroker/1/update",
                "/crm/businessbroker/all/",
                "/crm/supplier/add/",
                "/crm/supplier/1/update",
                "/crm/supplier/all/",
                "/crm/clients/ranking",
                "/expense/",
                "/expense/1",
                ...
                "/expense/chargeable/",
                "/expense/payment/",
                "/people/tasks/consultants_tasks",
                "/tag/1/",
                "/tag/manage",
                )
...
PYDICI_NON_HTML_PAGES = ("/leads/csv/all",
                         ...
                         "/staffing/timesheet/detailed/2010/11?csv",
                         "/billing/bill/client/pdf/1",
                         "/billing/bill/client/html/1",
                         "/billing/bill/internal/pdf/1",
                         "/billing/bill/internal/html/1",
                         "/billing/bill/file/client/1",
                         "/leads/csv/leads",
                         "/leads/csv/active-leads",
)
...
PYDICI_AJAX_PAGES = (
                ...
                "/crm/company/1/pivotable",
                "/billing/graph/yearly-billing",
                "/people/achievements/consultant/1/",
                "/people/detail/consultant/1/",
                "/people/profile/consultant/1/",
                "/people/graph/people-count/",
                "/leads/graph/leads-bar",
                "/leads/graph/won-rate",
                "/leads/graph/leads-pipe",
                "/leads/graph/leads-activity",
                "/leads/graph/activities-activity",
                "/billing/graph/billing",
                "/billing/graph/yearly-billing",
                ...
                "/crm/company/1/rates-margin",
                "/crm/company/1/billing",
)


PYDICI_FIXTURES = ["auth.json", "people.json", "crm.json",
                "leads.json", "staffing.json", "billing.json", "expense.json", "core.json"]
