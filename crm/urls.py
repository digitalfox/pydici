...
crm_urls = [
            ...
            url(r'^company/(?P<company_id>\d+)/pivotable$', v.company_pivotable, name="company-pivotable"),
            url(r'^company/all$', v.company_list),
            url(r'^company$', v.company),
            url(r'^company/(?P<company_id>\d+)/change$', v.company),
            url(r'^client$', v.client),
            url(r'^client/(?P<client_id>\d+)/change$', v.client, name="client_change"),
            url(r'^client-organisation$', v.clientOrganisation),
            ...
            url(r'^client-organisation-company-popup$', v.client_organisation_company_popup),
            ]
