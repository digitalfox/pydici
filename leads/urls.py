...
leads_urls = [url(r'^review', v.review),
              url(r'^csv/(?P<target>.*)', v.csv_export),
              url(r'^tag/(?P<tag_id>\d+)/$', v.tag),
              url(r'^tags/(?P<lead_id>\d+)$', v.tags),
              url(r'^tag/add$', v.add_tag),
              url(r'^tag/remove/(?P<tag_id>\d+)/(?P<lead_id>\d+)$', v.remove_tag),
              url(r'^(?P<lead_id>\d+)/$', v.detail),
              url(r'^leads$', v.leads),
              url(r'^lead$', v.lead),
              url(r'^lead/(?P<lead_id>\d+)/change$', v.lead),
              url(r'^documents/(?P<lead_id>\d+)/$', v.lead_documents),
              url(r'^sendmail/(?P<lead_id>\d+)/$', v.mail_lead),
              url(r'^mail/text', v.summary_mail, {"html": False}, name="lead-mail-text"),
              url(r'^mail/html', v.summary_mail, {"html": True}, name="lead-mail-html"),
              url(r'^graph/bar-jqp$', v.graph_bar_jqp),
              ...
              url(r'^pivotable/lead/(?P<lead_id>\d+)$', v.lead_pivotable, name="lead-pivotable"),
