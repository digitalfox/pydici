...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StateProba.score'
        db.alter_column(u'leads_stateproba', 'score', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'StateProba.score'
        db.alter_column(u'leads_stateproba', 'score', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        u'leads.lead': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 25, 0, 0)'}),
